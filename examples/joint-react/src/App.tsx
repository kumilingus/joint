...
interface ElementData extends Omit<GraphElement, 'id'> {
...
interface LinkData extends Omit<GraphLink, 'id'> {
...
const PAPER_PROPS: PaperProps<ElementData> = {
    ...
    measureNode: (node, view) => {
        ...
        if (node === view.el) {
            ...
            return new g.Rect({ x: 0, y: 0, width, height });
        }
...
const elements: Record<string, ElementData> = {
    '1': { x: 50, y: 110, angle: 30, title: 'This is error element' },
    '2': { x: 550, y: 110, title: 'This is info element' },
    '3': { x: 50, y: 370, color: '#f87171' },
    '4': {
        x: 550,
        y: 370,
        width: 100,
